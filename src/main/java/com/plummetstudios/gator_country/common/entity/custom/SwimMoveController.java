...
public class SwimMoveController extends MoveControl {
    ...
    public SwimMoveController(PathfinderMob entity, float speedMulti) {
        super(entity);
        this.entity = entity;
        this.speedMulti = speedMulti;
    }

    public SwimMoveController(PathfinderMob entity, float speedMulti, float yawLimit) {
        super(entity);
        this.entity = entity;
    ...
    public void tick() {
        ...
        if(entity instanceof AlligatorEntity && ((AlligatorEntity) entity).stopMoving){
